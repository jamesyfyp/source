...
started with the source default theme and am customizing it to my likings. I have modified the gulp file to allow for Tailwind/Daisy to work, and GSAP integrates via the main js file. Feel free to fork this and do as you please --JP,  remaining file unmodified for reference 
